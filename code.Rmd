...
bioquim2 <- ggdraw() +
            draw_plot(cst, width = 0.955, height = 0.268, x = -0.005, y = 0.75) +
            draw_plot(scr, width = 0.925, height = 0.268, x = 0.025, y = 0.50) +
            draw_plot(glc, width = 0.94, height = 0.268, x = 0.01, y = 0.25) +
            draw_plot(fts, width = 0.95, height = 0.268, x = 0.00, y = 0.00) +
            draw_plot_label(label = c("A", "B", "C", "D"),
                          x = c(0.92, 0.92, 0.92, 0.92),
                          y = c(1.00, 0.75, 0.50, 0.25))
